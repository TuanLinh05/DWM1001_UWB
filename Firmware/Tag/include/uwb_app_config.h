...
/*
 * Custom DWM1001C carrier profile.
 *
 * The large software offsets in Firmware Code Base belong to the previous
 * hardware/calibration set.  Start this PCB from the nominal DW1000 antenna
 * delay and publish measurements as calibration diagnostics until every
 * physical Tag/Anchor pair has been measured again.
 */
